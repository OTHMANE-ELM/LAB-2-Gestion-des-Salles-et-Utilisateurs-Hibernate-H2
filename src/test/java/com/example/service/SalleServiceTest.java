...
public class SalleServiceTest {
    ...
    public void testCrudOperations() {
        // Create
        Salle salle = new Salle("Test Salle", 20);
        salle.setDescription("Tester la description");
        salle.setEtage(1);
        ...
        assertEquals("Test Salle", foundSalle.get().getNom());
    ...
    public void testFindByDisponible() {
        ...
        Salle s2 = new Salle("Salle non disponible", 30);
        ...
        assertFalse(availableRooms.stream().anyMatch(s -> s.getNom().equals("Salle non disponible")));

        List<Salle> unavailableRooms = service.findByDisponible(false);
        assertTrue(unavailableRooms.stream().anyMatch(s -> s.getNom().equals("Salle non disponible")));
    ...
    public void testFindByCapaciteMinimum() {
        ...
        Salle s2 = new Salle("Moyenne salle", 50);
        ...
        assertEquals(2, roomsMin50.stream()
                .filter(s -> s.getNom().equals("Moyenne salle") || s.getNom().equals("Grande salle"))
                .count());
